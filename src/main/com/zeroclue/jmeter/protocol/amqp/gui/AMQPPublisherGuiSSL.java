...
import com.zeroclue.jmeter.protocol.amqp.AMQPPublisherSSL;
 ...
 *
 */
public class AMQPPublisherGuiSSL extends AMQPSamplerGuiSSL {
    ...
    */
    ...
    private JCheckBox persistent = new JCheckBox("Persistent?", AMQPPublisherSSL.DEFAULT_PERSISTENT);
    private JCheckBox useTx = new JCheckBox("Use Transactions?", AMQPPublisherSSL.DEFAULT_USE_TX);

    private ArgumentsPanel headers = new ArgumentsPanel("Headers");

    public AMQPPublisherGuiSSL(){
        init();
    }
    ...
    public void configure(TestElement element) {
        ...
        if (!(element instanceof AMQPPublisherSSL)) return;
        AMQPPublisherSSL sampler = (AMQPPublisherSSL) element;
    ...
    public TestElement createTestElement() {
        AMQPPublisherSSL sampler = new AMQPPublisherSSL();
    ...
    public void modifyTestElement(TestElement te) {
        AMQPPublisherSSL sampler = (AMQPPublisherSSL) te;
        sampler.clear();
    ...
    private void configureHeaders(AMQPPublisherSSL sampler)
    {
