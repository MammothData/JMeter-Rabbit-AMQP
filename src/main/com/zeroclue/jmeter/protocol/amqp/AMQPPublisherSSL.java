 ...
 */
public class AMQPPublisherSSL extends AMQPSamplerSSL implements Interruptible {
    ...
    private final static String MESSAGE = "AMQPPublisherSSL.Message";
    private final static String MESSAGE_ROUTING_KEY = "AMQPPublisherSSL.MessageRoutingKey";
    private final static String MESSAGE_TYPE = "AMQPPublisherSSL.MessageType";
    private final static String REPLY_TO_QUEUE = "AMQPPublisherSSL.ReplyToQueue";
    private final static String CORRELATION_ID = "AMQPPublisherSSL.CorrelationId";
    private final static String HEADERS = "AMQPPublisherSSL.Headers";
    ...
    public SampleResult sample(Entry e) {
        ...
        try {
            ...
            if(!getSslUserId().isEmpty()){
                messageProperties.setUserId(getSslUserId());
            }
